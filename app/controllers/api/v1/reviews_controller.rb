class Api::V1::ReviewsController < Api::V1::BaseController
  ...
  def index
    ...
    if (sort=="id" || sort=="business_id" || sort =="user_id" || sort == "created_at" || sort == "updated_at" || sort == "stars") then
  ...
  private
    ...
    def review_params
      params.require(:review).permit(:yelp_business_id, :yelp_user_id, :content)
    end
    
    def query_params
      # Requie auth here: ex params.require(:auth)
      params.permit(:id, :yelp_business_id, :yelp_user_id)
    end
